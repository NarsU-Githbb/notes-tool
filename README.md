Tool for managing & storing notes
...
6. Use exit when you don't want to use it anymore & you'll be back using terminal in no time.
7. Still need help? You can use our help menu when you write "go run . help" in the terminal. 

Notes tool is perfect for storing your ideas & organizing them into neat little packages for possible future use. It will make sure that your very unique ideas won't never go to waste again!